...
public class WechatConfig {
     ...
     * 是否开启微信支付接口日志记录
     */
    private static Boolean enableWechatPayLog;
    ...
    public static boolean getEnableWechatPayLog() {
        if (null == enableWechatPayLog) {
            enableWechatPayLog = SP.getBooleanProperty(WechatConfigEnum.ENABLE_WECHAT_PAY_LOG.getKey(), false);
        }

        return enableWechatPayLog;
    }
